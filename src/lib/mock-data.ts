...
export const sectors: {
  ...
  { id: "e-waste", name: "E-Waste / Electronics", icon: "🔌", short: "Recover value from old electronics and safely handle hazardous components.", examples: "Circuit boards, motherboards, phones, chargers, laptops, cables, small appliances.", detail: "Upload devices like phones, computers and chargers. We classify hazardous electronics and match them to certified recovery routes." },
  { id: "plastic", name: "Plastic", icon: "🧴", short: "Sort household and packaging plastics by polymer type for clean recycling.", examples: "PET bottles, HDPE containers, plastic packaging, household plastics.", detail: "Submit plastic bottles, containers and packaging. We guide you to the correct polymer stream for reuse or industrial recovery." },
  { id: "metal", name: "Metal / Recovery Materials", icon: "🥫", short: "Aluminum, steel and scrap metals recovered for smelting and reuse.", examples: "Cans, scrap metal, metal parts, household metal waste, device housings.", detail: "Capture metal items and components. Our platform routes them through recycling partners for maximum material recovery." },
  { id: "glass", name: "Glass", icon: "🍾", short: "Clean glass streams turned into new bottles and containers.", examples: "Bottles, jars, glass containers, reusable and recyclable glass materials.", detail: "Upload glass containers and bottles to keep them in the circular economy rather than landfill." },
  { id: "paper-cardboard", name: "Paper & Cardboard", icon: "📦", short: "Fibre-based packaging recovered into new paper products.", examples: "Cartons, paper packaging, cardboard boxes, office paper.", detail: "Submit paper and cardboard materials for pulping and reuse in new packaging and stationery." },
  { id: "textile", name: "Clothing & Textiles", icon: "👕", short: "Recycle and reuse textiles, garments, leather, and fabric materials to divert them from landfills.", examples: "Shirts, Trousers, Dresses, Jackets, Shoes, Bags, Uniforms, Curtains, Bedsheets, Towels, Fabric offcuts, Leather products, Denim, Cotton, Polyester, Mixed textiles.", detail: "Donate wearable clothing and shoes for reuse, or submit worn textiles, leather products, fabric offcuts and polyester materials for fibre recovery and recycling." },
];
